<script lang="ts">
  ...
  function onTitleInput(event: Event) {
    if (slugManuallyEdited || !slugEl) return;
...
<svelte:head>
  <title>Nieuwe pagina — Beheer</title>
</svelte:head>
...
<div class="mx-auto max-w-3xl p-8">
  <div class="mb-6 flex items-center gap-3">
    ...
    <h1 class="text-xl font-bold text-forest-800 dark:text-forest-200">Nieuwe pagina</h1>
  </div>
